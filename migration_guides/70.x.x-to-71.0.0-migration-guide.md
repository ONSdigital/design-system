...
### **_Update icon sizes naming standard_**

[**Link to PR**](https://github.com/ONSdigital/design-system/pull/3285)

-   **Description of change:** Icon sizes have been updated with the new naming size standard.
-   **Reason for change:** Updated icon sizes to match the naming size standard.
...
### **_Update font sizes naming standard_**

[**Link to PR**](https://github.com/ONSdigital/design-system/pull/3285)

-   **Description of change:** font sizes have been updated with the new naming size standard.
-   **Reason for change:** Updated font sizes to match the naming size standard.
