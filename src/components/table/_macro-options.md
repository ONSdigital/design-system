...
| ------------- | ------------------- | ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| id            | string              | false                                 | An `id` applied to the wrapping element. Also used to derive the table element `id` (as `table--{id}`). Required if using footnotes or download                                                          |
...
| figureNumber  | string              | false                                 | A figure number displayed above the title, e.g. “Table 1”                                                                                                                                                |
| title         | string              | false                                 | The title displayed above the table                                                                                                                                                                      |
| subtitle      | string              | false                                 | The subtitle displayed below the title                                                                                                                                                                   |
| footnotes     | `Object<Footnotes>` | false                                 | Footnotes to appear below the table. See [figure](/components/figure) for `Footnotes` options                                                                                                            |
| download      | `Object<Download>`  | false                                 | Download options displayed below the table. See [figure](/components/figure) for `Download` options                                                                                                      |
| variants      | array or string     | false                                 | An array of values or single value (string) to adjust the component using available variants: “compact”, “responsive”, “sortable”, and “row-hover”                                                       |
| tableClasses  | string              | false                                 | Classes to add to the `<table>` element of the component                                                                                                                                                 |
| caption       | string              | false                                 | The table caption. Note that the caption is rendered inside the table element. To render it below using the onsFigure caption, use the `figureCaption` parameter.                                        |
| hideCaption   | boolean             | false                                 | Set to “true” to visually hide the table caption                                                                                                                                                         |
| ariaLabel     | string              | false                                 | The ARIA label for the table. This is optional, because if the table has a caption, then screen readers will use this to understand the table.                                                           |
| figureCaption | string              | false                                 | The caption rendered below the table using the onsFigure caption option. Note that for a table this will render as a span element.                                                                       |
