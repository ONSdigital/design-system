...
| figure_number | string              | false                                 | A figure number displayed above the title, e.g. “Table 1”                                                                                                                                                |
...
| caption       | string              | false                                 | The caption for the table component Note that the caption is rendered inside the table element, and we deliberately do not render it with the onsFigure caption option.                                  |
