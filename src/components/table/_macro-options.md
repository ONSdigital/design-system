...
| caption      | string              | false                                 | The table caption.                                                                                                                                                                                       |
...
| sourceNote   | string              | false                                 | A note displayed below the table. Can be used to name, describe or caveat the table source data.                                                                                                         |
