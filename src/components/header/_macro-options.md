...
| signoutButton         | object`<SignOutButton>`                           | false                                                       | Settings for the [sign out button](#signoutbutton) in the header used to exit a transactional service. The legacy `button` alias is still supported. |
