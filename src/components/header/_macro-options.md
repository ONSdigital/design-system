...
| mastheadLogoAltText   | string                                            | false                                                       | Optional logo alt text override. Defaults to 'Office for National Statistics logo', or 'Logo Swyddfa Ystadegau Gwladol' when the current language is Welsh |
