...
| ------------------------ | ------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| chartType                | string  | true     | The type of chart to render. Supported types include: 'line', 'bar', 'column', 'scatter', 'columnrange', 'boxplot' and 'area'.                                                               |
...
| legend                   | boolean | false    | Whether the legend is displayed. Defaults to `true`. Note that legends are automatically hidden for single series charts.                                                                    |
...
| min                      | number       | false    | Sets the minimum value for the Y-axis. Relevant for Line, area, column chart, column-range, boxplot and scatter charts.                                                                                                                                  |
| max                      | number       | false    | Sets the maximum value for the Y-axis. Relevant for Line, area, column chart, column-range, boxplot and scatter charts.                                                                                                                                  |
| startOnTick              | boolean      | false    | Align the axis to start on a tick. Relevant for Line, area, column chart, column-range, boxplot and scatter charts.                                                                                                                                      |
| endOnTick                | boolean      | false    | Align the axis to end on a tick. Relevant for Line, area, column chart, column-range, boxplot and scatter charts.                                                                                                                                        |
...
| tickIntervalMobile  | number  | false    | The interval of the tick marks in axis units at mobile. Useful when you want to space out the labels (e.g. show every 2nd or 5th label).                                     |
| tickIntervalDesktop | number  | false    | The interval of the tick marks in axis units at desktop. Useful when you want to space out the labels (e.g. show every 2nd or 5th label).                                    |
| min                 | number  | false    | Sets the minimum value for the X-axis. Relevant for bar chart and scatter charts.                                                                                            |
| max                 | number  | false    | Sets the maximum value for the X-axis. Relevant for bar chart and scatter charts.                                                                                            |
| startOnTick         | boolean | false    | Align the axis to start on a tick. Relevant for bar chart and scatter charts.                                                                                                |
| endOnTick           | boolean | false    | Align the axis to end on a tick. Relevant for bar chart and scatter charts.                                                                                                  |
...
| dataLabels   | boolean | false    | Options for whether the DataLabel is displayed. Defaults to `false`. This option is only available for bar chart and clustered bar charts with two or fewer series.                                                                                                                                                                                                                                                                           |
