...
| marker       | boolean | false    | Options for whether the Marker is displayed on the data points. Defaults to `false`. This option is only available for line and scatter charts. Note: When using scatter with columnrange chart types, marker is required and must be set to true.                                                                                                                                                                                            |
