...
| target              | string            | false    | Sets the HTML `target` attribute for the list item link when `url` is set                                                              |
| download            | string            | false    | Sets the HTML `download` attribute for the list item link when `url` is set                                                            |
