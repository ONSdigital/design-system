...
| ariaLabel         | string                                                   | false                         | Descriptive landmark ARIA label for the `<nav>` element to give a screen reader user greater understanding of its purpose. Defaults to “Table of contents”.                                                        |
| ariaLabelForAside | string                                                   | false                         | Descriptive landmark ARIA label for the `<aside>` element to give a screen reader user greater understanding of its purpose. Defaults to ”Table of contents”.                                                      |
