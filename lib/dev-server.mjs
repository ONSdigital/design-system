...
import { handleTypeRoute, handleExamplesRoute } from './handle-routes.mjs';
import { pages, title, pageSearch } from './config.indexPage.mjs';
...
(async () => {
    ...
    app.all('/test/fake/*splat', (req, res) => {
        res.status(200).json({});
    });
