...
import renderPageList from './render-page-list.js';
import { handleTypeRoute, handleExamplesRoute } from './handle-routes.js';
import { pages, title, pageSearch } from './config.indexPage.js';
