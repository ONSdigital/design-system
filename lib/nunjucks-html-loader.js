...
export default async function(source) {
  ...
  let html = await renderHTML(nunjucks, source, environment, context, options, callback);
  ...
  html = await renderHTML(nunjucks, source, environment, context, options, callback);
...
function renderHTML(nunjucks, source, environment, context, options, callback) {
