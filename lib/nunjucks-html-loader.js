...
import { navigationHelper, subNavigationHelper, generateExampleParams, createIndex } from './helpers';
...
export default async function(source) {
  ...
  const excludePage = frontmatterData && frontmatterData.exclude ? true : false;
  ...
  if (isExample === false && excludePage === false) {
    createIndex(pageInfo);
  }
